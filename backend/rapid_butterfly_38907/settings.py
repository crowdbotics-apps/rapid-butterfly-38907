"""
Django settings for rapid_butterfly_38907 project.
...
ROOT_URLCONF = 'rapid_butterfly_38907.urls'
...
WSGI_APPLICATION = 'rapid_butterfly_38907.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "rapid_butterfly_38907 API",
    "DESCRIPTION": "API documentation for rapid_butterfly_38907 App",
    "VERSION": "v1",
}
